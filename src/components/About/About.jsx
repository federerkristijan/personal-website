  ...
  return (
    <div className="about-wrapper" id="about">
      ...
      <div className="a-text">
        ...
        with a healthy work environment, that would allow me to dive deeper into
        wonderful world of coding, embrace new creative challenges, and further develop my skills and learn new ones.
      </div>
    </div>
  );
};
